...
export const metadata: Metadata = {
  title: "Husnain Rehman | Frontend Developer",
  description:
    "I am a Frontend Developer specializing in Next.js, Shopify, Hubspot and modern web experiences. Explore my portfolio and projects.",
};
